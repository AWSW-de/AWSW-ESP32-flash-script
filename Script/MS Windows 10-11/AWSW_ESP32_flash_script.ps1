...
$ScriptVersion = "V1.3.0" # 11.03.2025
...
Do{
    #cls
    CreateMenu -Selections 'WordClock 16x8     - 2023           (ESP32 D1 mini)','WordClock 16x16    - 2023           (ESP32 D1 mini)','WordClock 16x8     - 2024/2025      (ESP32 NodeMCU)','WordClock 16x16    - 2024/2025      (ESP32 NodeMCU)','WordCalendar 16x16 - 2024/2025      (ESP32 NodeMCU)' -Title 'Choose your AWSW project to flash to the ESP32:' -IncludeExit -IncludeErase # 
